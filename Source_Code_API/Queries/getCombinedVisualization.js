...
const getCombinedVisualization = (timeStamp) => {
    return 'WITH toString(datetime(\'' + timeStamp + '\') - duration(\'PT12H\')) AS firstTwelveT, toString(datetime(\'' + timeStamp + '\') + duration(\'PT12H\')) AS secondTwelveT ' +
            ...
            'AND b.time >= (datetime(\'' + timeStamp + '\') - duration(\'PT12H\')) AND b.time <= (datetime(\'' + timeStamp + '\') + duration(\'PT12H\')) ' +
...
module.exports = getCombinedVisualization;